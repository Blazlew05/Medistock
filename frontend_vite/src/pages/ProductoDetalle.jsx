import { AlertCircle, ArrowLeft, Package, ShoppingCart, Truck } from "lucide-react";
...
export default function ProductoDetalle() {
  ...
  useEffect(() => {
    setCargando(true);
    api.get(`/api/v1/productos/${codigo}`).then(setProducto).finally(() => setCargando(false));
  }, [codigo]);
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      <Link to="/catalogo" className="inline-flex items-center gap-1 text-sm text-slate-600 hover:text-primary-700 mb-6">
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <input
                  ...
                  className="w-20 border-y border-slate-300 px-3 py-2 text-center"
                />
