import { ArrowRight, Clock, Heart, Package, Pill, ShieldCheck, Stethoscope, Truck } from "lucide-react";
          ...
          <div className="grid gap-12 md:grid-cols-2 items-center">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link to="/catalogo" className="inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 font-semibold text-primary-800 hover:bg-primary-50">
                  Ver catálogo <ArrowRight className="h-4 w-4" />
                </Link>
                <Link to="/registro" className="inline-flex items-center gap-2 rounded-lg border border-white/30 bg-white/10 px-6 py-3 font-semibold text-white hover:bg-white/20">
                  Soy una institución
                </Link>
              </div>
            </div>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {[
            ...
            <Link
              key={c.n}
              to={`/catalogo?categoria=${encodeURIComponent(c.n)}`}
              className="group rounded-xl border border-slate-200 bg-white p-6 hover:border-primary-500 hover:shadow-lg transition"
            >
      ...
      <section className="bg-slate-50 border-y border-slate-200">
        <div className="mx-auto max-w-7xl px-4 py-16 grid md:grid-cols-2 gap-8">
          <div className="rounded-2xl bg-white border border-slate-200 p-8">
            ...
            <Link to="/registro" className="mt-6 inline-flex btn-primary">Crear cuenta institucional</Link>
          </div>
          <div className="rounded-2xl bg-white border border-slate-200 p-8">
            ...
            <Link to="/catalogo" className="mt-6 inline-flex btn-primary">Ver productos</Link>
          </div>
        </div>
      </section>
    </div>
